...
import xyz.harmonyapp.olympusblog.utils.Constants.Companion.TESTING_CACHE_DELAY
import xyz.harmonyapp.olympusblog.utils.Constants.Companion.TESTING_NETWORK_DELAY
import xyz.harmonyapp.olympusblog.utils.ErrorHandling.Companion.ERROR_CHECK_NETWORK_CONNECTION
...
abstract class NetworkBoundResource<ResponseObject, CacheObject, ViewStateType>
    ...
    fun onErrorReturn(errorMessage: String?, shouldUseDialog: Boolean, shouldUseToast: Boolean) {
        ...
        when {
            ...
            ErrorHandling.isNetworkError(msg) -> {
                msg = ERROR_CHECK_NETWORK_CONNECTION
                useDialog = false
            }
            else -> {
                msg = ErrorHandling.parseDetailJsonResponse(msg)
            }
        }
        if (shouldUseToast) {
